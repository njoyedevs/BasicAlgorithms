...
//     let trackerVariable = 0;
//     let sumTracker = 0;

//     // iterate through array locating the largest numbers - previous number.  
//     for (let i = 0; i < waterLevels.length; i++) {
//         // console.log((waterLevels[i+1]- waterLevels[i]))
//         if ((waterLevels[i + 1] - waterLevels[i]) > 0) {
//             trackerVariable += ((waterLevels[i + 1] - waterLevels[i]))
//             // console.log(`This is the tracker variable: `, trackerVariable)

//             if (trackerVariable > sumTracker) {
//                 sumTracker = trackerVariable
//             }
//         } else {
//             trackerVariable = 0;
//         }
