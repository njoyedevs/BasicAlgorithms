...
function groupObjects(items) { 
    ...
    for (const item of items) {
        ...
        if (!newObject.hasOwnProperty(item.category.toLowerCase())) {
            newObject[item.category.toLowerCase()] = []
        }
        newObject[item.category.toLowerCase()].push(item)
    }
    console.log(newObject);
    // Array of array of ojects
    console.log(Object.values(newObject));
    // Array of array of array of objects
